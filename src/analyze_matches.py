...
def main():
    ...
    print(df_2026_sorted[["date", "first_batting_team", "second_batting_team"]].tail(5).to_string()) #sort the 2026 matches using data and print the tail to get the latest matches
